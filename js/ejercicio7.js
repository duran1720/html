//7. En  este  script  debe  pedir  al  usuario  un  número  de  dos  dígitos  y  debe devolver  el número  de 
...
let numero=parseInt(prompt("Escribe un número de dos dígitos: "));
